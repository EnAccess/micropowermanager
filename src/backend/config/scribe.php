...
DESC,
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // TODO: excluding routes that throw errors when scraping
                // core
                'api/e-bikes/search',
                ...
                'api/paymenthistories/*',
                'api/dashboard/agents',
                'api/dashboard/mini-grids/*',
                'api/dashboard/clusters/*',
                'api/clusters/*',
                'api/appliances/person/*',
                'api/tickets/reports/download/*',
                'api/tickets/ticket/*',
                'api/addresses/*',
                'api/transactions/*',
                'api/transactions/analytics/*',
                // agent
                'api/agents/balance/history/*',
                'api/agents/receipt/*',
                'api/agents/sold/*',
                'api/agents/assigned/*',
                'api/agents/search',

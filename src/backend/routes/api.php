...
use App\Http\Controllers\ClusterImportController;
...
Route::group(['prefix' => 'solar-home-systems', 'middleware' => 'auth:api'], static function () {
    ...
    Route::get('/{id}/device-info', [SolarHomeSystemController::class, 'deviceInfo']);
});
...
Route::group(['prefix' => 'import'], static function () {
    ...
    Route::post('/clusters', [ClusterImportController::class, 'import'])->middleware('permission:customers');
    Route::post('/devices', [DeviceImportController::class, 'import'])->middleware('permission:customers');

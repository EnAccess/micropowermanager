...
class ThirdPartyTransactionService implements PaymentInitiator {
    ...
    public function initiatePayment(
        ...
        if ($source === null || $source === '') {
            throw new \InvalidArgumentException('source is required to register a third-party transaction');
        }
        ...
        $transaction = DB::transaction(function () use ($amount, $sender, $message, $type, $externalReference, $apiKey, $source) {
            $thirdPartyTransaction = $this->thirdPartyTransaction->newQuery()->create([
                ...
                'source' => $source,
                'description' => sprintf('Payment generated by %s from %s', $apiKey->name, $source),
            ]);

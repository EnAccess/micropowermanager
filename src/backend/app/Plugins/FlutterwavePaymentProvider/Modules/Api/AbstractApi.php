...
use App\Plugins\FlutterwavePaymentProvider\Modules\Api\Resources\AbstractApiResource;
...
abstract class AbstractApi {
    ...
    public function doRequest(AbstractApiResource $resource): AbstractApiResource {
        ...
        if ($statusCode !== 200 && $statusCode !== 201) {
            throw new FlutterwaveApiException($response->getStatusCode(), $resource->getUri(), $response->getBody()->getContents());
        }

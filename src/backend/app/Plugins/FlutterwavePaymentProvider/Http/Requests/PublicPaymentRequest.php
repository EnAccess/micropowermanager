...
class PublicPaymentRequest extends FormRequest {
    ...
    public function rules(): array {
        $supportedCurrencies = config('flutterwave-payment-provider.currency.supported', ['NGN', 'GHS', 'KES', 'ZAR', 'USD']);
    ...
    public function messages(): array {
        $supportedCurrencies = config('flutterwave-payment-provider.currency.supported');
    ...
    public function getFlutterwaveTransaction(): FlutterwaveTransaction {
        ...
        return new FlutterwaveTransaction([

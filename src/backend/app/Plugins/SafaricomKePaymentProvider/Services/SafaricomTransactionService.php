...
class SafaricomTransactionService extends AbstractPaymentAggregatorTransactionService implements IBaseService, PaymentInitiator {
    ...
    public function initiatePayment(
        ...
        try {
            ...
            $safaricomTxn->checkout_request_id = (string) $result['checkout_request_id'];
            $safaricomTxn->merchant_request_id = (string) $result['merchant_request_id'];
            ...
            return [
                ...
                'provider_data' => [
                    'reference_id' => $safaricomTxn->reference_id,
                    'checkout_request_id' => $safaricomTxn->checkout_request_id,
                    'merchant_request_id' => $safaricomTxn->merchant_request_id,

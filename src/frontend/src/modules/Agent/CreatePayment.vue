        ...
        <md-card>
          ...
          <md-card-content>
            <form @submit.prevent="createPayment">
              ...
              <div class="md-layout md-gutter" v-if="selectedCustomer && selectedCustomer.devices.length > 1">
                <div class="md-layout-item md-size-100">
                  <md-field>
                    <label>{{ $tc("words.meter") }}</label>
                    <md-select v-model="paymentForm.meterSerial" :disabled="loading">
                      <md-option 
                ...
                <div class="md-layout-item md-size-100">
                  <md-field>
                    ...
                    <md-select v-model="paymentForm.purpose" :disabled="loading">
                      <md-option value="energy">{{ $tc("words.energy") }} {{ $tc("phrases.topUp") }}</md-option>
                      <md-option value="appliance">{{ $tc("words.appliance") }} {{ $tc("words.payment") }}</md-option>
                      <md-option value="maintenance">{{ $tc("words.maintenance") }} {{ $tc("words.fee") }}</md-option>
  ...
  methods: {
    ...
    onCustomerSelected(customerId) {
      ...
      if (this.selectedCustomer && this.selectedCustomer.devices.length === 1) {
        this.paymentForm.meterSerial = this.selectedCustomer.devices[0].device_serial
      } else {
        this.paymentForm.meterSerial = null
      }
    },
    ...
    async createPayment() {
      ...
      try {
        ...
        const transactionData = {
          ...
          meter_serial: this.paymentForm.meterSerial,
        ...
        if (response && response.data) {          
          ...
          this.generatedPayment = {
            ...
            meter_serial: transactionData.meter_serial,

        ...
        <div class="md-toolbar-row">
            ...
            <div class="md-toolbar-section-end">
                <div>
                    ...
                    >
                        <md-button
                            class="md-dense nav-button md-raised"
                            md-menu-trigger
                        >
                        ...
                        <md-menu-content>
                            ...
                            <md-menu-item
                                @click="replaceRoute('/locations/add-cluster')"
                            >
                                {{ $tc('menu.subMenu.addCluster') }}
                            </md-menu-item>
                            <md-menu-item
                                @click="
                                    replaceRoute('/locations/add-mini-grid')
                                "
                            >
                                {{ $tc('menu.subMenu.addMiniGrid') }}
                            </md-menu-item>
                            <md-menu-item
                                @click="replaceRoute('/locations/add-village')"
                            >
                    ...
                    >
                        ...
                        <md-menu-content>
                            ...
                            <md-menu-item
                                @click="replaceRoute('/connection-groups')"
                            >
                                {{ $tc('words.group', 2) }}
                            </md-menu-item>
                            <md-menu-item
                                @click="replaceRoute('/connection-types')"
                            >
                                {{ $tc('words.type', 2) }}
                            </md-menu-item>
                        </md-menu-content>
                    ...
                    >
                        ...
                        <md-menu-content>
                            ...
                            <md-menu-item
                                @click="replaceRoute('/profile/management')"
                            >

                ...
                <div class="md-layout-item md-size-100">
                    <md-table md-card style="margin-left: 0">
                        <md-table-row>
                            ...
                            <md-table-head>
                                Positive Reactive Value
                            </md-table-head>
                            <md-table-head>Inverted Active Value</md-table-head>
                            <md-table-head>
                                Inverted Reactive Value
                            </md-table-head>
                            <md-table-head>
                                Positive Active Daily Power
                            </md-table-head>
                            <md-table-head>
                                Positive Reactive Daily Power
                            </md-table-head>
                            <md-table-head>
                                Inverted Active Daily Power
                            </md-table-head>
                            <md-table-head>
                                Inverted Reactive Daily Power
                            </md-table-head>
                        ...
                        <md-table-row>
                            ...
                            <md-table-cell>
                                {{
                                    this.statusService.status
                                        .invertedReactiveValue
                                }}
                            </md-table-cell>
                            <md-table-cell>
                                {{
                                    this.statusService.status
                                        .positiveActiveDailyPower
                                }}
                            </md-table-cell>
                            <md-table-cell>
                                {{
                                    this.statusService.status
                                        .positiveReactiveDailyPower
                                }}
                            </md-table-cell>
                            <md-table-cell>
                                {{
                                    this.statusService.status
                                        .invertedActiveDailyPower
                                }}
                            </md-table-cell>
                            <md-table-cell>
                                {{
                                    this.statusService.status
                                        .invertedReactiveDailyPower
                                }}
                            </md-table-cell>
                            <md-table-cell>
    ...
    methods: {
        ...
        async getMeterStatus() {
            try {
                ...
                this.statusOfMeter =
                    this.statusService.status.meterStatus === 'ON'
            } catch (e) {
        ...
        async changeMeterStatus(status) {
            try {
                ...
                let message =
                    status === true
                        ? 'Meter status set as ON'
                        : 'Meter status set as OFF'

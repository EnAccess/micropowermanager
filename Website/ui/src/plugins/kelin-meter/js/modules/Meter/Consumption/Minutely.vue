        ...
        >
            ...
            >
                <md-table-row slot="md-table-row" slot-scope="{ item }">
                    <md-table-cell
                        md-label="Terminal ID"
                        md-sort-by="terminalId"
                    >
                        {{ item.terminalId }}
                    </md-table-cell>
                    <md-table-cell
                    ...
                    <md-table-cell
                        md-label="Date of Data"
                        md-sort-by="dateOfData"
                    >
                        {{ item.dateOfData }}
                    </md-table-cell>
                    <md-table-cell
                        md-label="Time of Data"
                        md-sort-by="timeOfData"
                    >
                        {{ item.timeOfData }}
                    </md-table-cell>
                    <md-table-cell
                    ...
                    <md-table-cell
                        md-label="Power Factor"
                        md-sort-by="powerFactor"
                    >
                        {{ item.powerFactor }}
                    </md-table-cell>
                    <md-table-cell
                        md-label="Reactive Power"
                        md-sort-by="reactivePower"
                    >
                        {{ item.reactivePower }}
                    </md-table-cell>
                    <md-table-cell
                    ...
                    <md-table-cell
                        md-label="Temperature 1"
                        md-sort-by="temperature1"
                    >
                        {{ item.temperature1 }}
                    </md-table-cell>
                    <md-table-cell
                        md-label="Temperature 2"
                        md-sort-by="temperature2"
                    >
                        {{ item.temperature2 }}
                    </md-table-cell>
                    ...
                    <md-table-cell
                        md-label="Flow Velocity"
                        md-sort-by="flowVelocity"
                    >
                        {{ item.flowVelocity }}
                    </md-table-cell>
                </md-table-row>

<template>
    <div>
        ...
        >
            <form
                @submit.prevent="submitTariffForm"
                ...
                <md-card>
                    <md-card-content>
                        <div class="md-layout md-gutter">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <md-input
                                        ...
                                        v-model="
                                            tariffService.tariff.flatLoadLimit
                                        "
                                        v-validate="'required|numeric'"
                                    />
                                    <span class="md-error">
                            ...
                            >
                                <div class="md-layout md-gutter">
                                    ...
                                    >
                                        <md-checkbox
                                            v-model="
                                                tariffService.tariff.planEnabled
                                            "
                                    ...
                                    >
                                        <md-checkbox
                                            v-model="
                                                tariffService.tariff.touEnabled
                                            "
                            ...
                            <div
                                v-if="
                                    tariffService.tariff.dailyEnergyLimitEnabled
                                "
                            ...
                            >
                                ...
                                >
                                    ...
                                    <md-select
                                        v-model="
                                            tariffService.tariff.planDuration
                                        "
                                        name="plan_duration"
                                        id="plan_duration"
                                    >
                            ...
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Tariff-Form.plan_fixed_fee',
                                        ),
                                    }"
                                >
                                    <label for="plan_fixed_fee">
                                        Plan Fixed Fee
                                    </label>
                                    <md-input
                                        id="plan_fixed_fee"
                                        name="plan_fixed_fee"
                                        v-model="
                                            tariffService.tariff.planFixedFee
                                        "
                                        type="number"
                                        v-validate="{
                                            required:
                            ...
                            >
                                <md-button
                                    role="button"
                                    :disabled="
                                        tariffService.conflicts.length > 0
                                    "
                            ...
                            <div
                                class="md-layout-item md-xlarge-size-100 md-large-size-100 md-medium-size-100 md-small-size-100"
                                v-for="(tou, index) in tariffService.tariff
                                    .tous"
                                :key="'tou' + index"
                            >
                                <div class="md-layout md-gutter">
        ...
        async submitTariffForm() {
            ...
            if (validator) {
                try {
                    ...
                    this.alertNotify(
                        'success',
                        'Tariff has updated successfully.',
                    )

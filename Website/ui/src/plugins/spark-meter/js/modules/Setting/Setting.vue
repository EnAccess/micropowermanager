                    ...
                    <md-card class="setting-card">
                        ...
                        <md-card-content>
                            <form data-vv-scope="Synchronization-Form">
                                <div
                                    v-for="(setting, i) in settingService.list"
                                    :key="i"
                                >
                                    <div
                                        v-if="
                                            setting.settingTypeName ===
                                            'spark_sync_setting'
                                        "
                                    ...
                                    >
                                        ...
                                        >
                                            <md-field
                                                :class="{
                                                    'md-invalid': errors.has(
                                                        'Synchronization-Form.max_attempt_' +
                                                            setting.id,
                                                    ),
                                                }"
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <md-input
                                                            ...
                                                            min="10"
                                                            v-validate="
                                                                'required|min_value:10'
                                                            "
                                                        />
                                                        <span class="md-error">
                                                            {{
                                                                errors.first(
                                                                    'Main-Formsend_elder_' +
                                                                        setting.id,
                                                                )
                                                            }}
                                                        </span>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            Meter Reset Key is for the customers
                                            that want to clear the meter's error
                                            state (throttle error or protect) if
                                            one exists. When the customers want
                                            to reset their meter, they need to
                                            send this key as SMS"
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            Current Balance Key is for the
                                            customers that want to get their
                                            current balance. When the customers
                                            want to get their current balance,
                                            they need to send this key as SMS"
                                        </div>
                                        <div class="md-layout-item md-size-100">
                                            <md-field
                                                :class="{

                ...
                <md-table v-model="ticketUserService.list" md-sort="name" md-sort-order="asc" md-card>
                    <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell :md-label="$tc('words.tag')" md-sort-by="tag">
                          <input type="checkbox" :checked="item.isTicketingUser" @change="(e) => updateTicketingUser(e.target.checked, item.id)">
                        </md-table-cell>
...
import AddExternalTicketingUser from "@/components/Ticket/AddExternalTicketingUser";

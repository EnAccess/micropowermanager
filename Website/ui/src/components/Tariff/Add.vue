    ...
    <div>
        ...
        >
            <md-card>
                    ...
                    <div class="md-layout md-gutter">
                        ...
                        <div class="md-layout-item md-size-100">
                            <form class="md-layout md-gutter" data-vv-scope="Tariff-Form">
                                ...
                                <div class="md-layout-item  md-size-50 md-small-size-100">
                                    <md-checkbox :name="$tc('phrases.enableAccessRate')"
                                                 :id="$tc('phrases.enableAccessRate')"
                                                 v-model="hasAccessRate" @change="accessRateChange($event)">
                                        {{ $tc('phrases.enableAccessRate') }}?
                                    </md-checkbox>
                                </div>
                                <div class="md-layout-item md-size-50 md-small-size-100">
                                    <md-field
                                        :class="{'md-invalid': errors.has('Tariff-Form.' + $tc('words.minimumPurchaseAmount'))}">
                                        <label for="minimumPurchaseAmount">{{
                                                $tc('phrases.minimumPurchaseAmountDescription')
                                            }}</label>
                                        <md-input id="minimumPurchaseAmount"
                                                  :name="$tc('words.minimumPurchaseAmount')"
                                                  v-model="tariffService.tariff.minimumPurchaseAmount"
                                                  v-validate="'required|decimal:2'"
                                        />
                                        <span class="md-error">{{
                                                errors.first('Tariff-Form.' + $tc('words.minimumPurchaseAmount'))
                                            }}</span>
                                    </md-field>
                                </div>
                            </form>
                        ...
                        <div class="md-layout-item md-size-100"
                            ...
                            <form class="md-layout md-gutter" data-vv-scope="Access-Rate-Form">
                                ...
                                <div class="md-layout-item md-size-50 md-small-size-100">
                                    <md-field
                                        :class="{'md-invalid': errors.has('Access-Rate-Form.' + $tc('phrases.accessRatePrice'))}">
                                        ...
                                        <span
                                            class="md-error">{{
                                                errors.first('Access-Rate-Form.' + $tc('phrases.accessRatePrice'))
                                            }}</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-size-50 md-small-size-100">
                                    <md-field
                                        ...
                                        <span
                                            class="md-error">{{
                                                errors.first('Access-Rate-Form.' + $tc('phrases.accessRatePeriodInDays'))
                                            }}</span>
                                    </md-field>
                                </div>
                            </form>
                        ...
                        <div class="md-layout-item md-size-100"
                            ...
                            <form class="md-layout md-gutter" data-vv-scope="Component-Form">
                                <div class="md-layout-item md-size-45 md-small-size-100">
                                    ...
                                    <md-field
                                        :class="{'md-invalid': errors.has('Component-Form.' + $tc('words.name'))}">
                                ...
                                <div class="md-layout-item md-size-45 md-small-size-90">
                                    ...
                                    <md-field
                                        :class="{'md-invalid': errors.has('Component-Form.' + $tc('phrases.componentPrice'))}">
                                        ...
                                        />
                                        <span class="md-error">{{
                                                errors.first('Component-Form.' + $tc('phrases.componentPrice'))
                                            }}</span>
                                    </md-field>
                                </div>
                        ...
                        <div class="md-layout-item  md-size-100">
                            <md-button role="button" :disabled="tariffService.conflicts.length>0"
                                       class="md-raised md-secondary" @click="addComponent('usage')">
                                <md-icon>add</md-icon>
                                {{ $tc('phrases.addTou') }}
                            </md-button>
                            ...
                            <form class="md-layout md-gutter" data-vv-scope="Tou-Form">
                                <div class="md-layout-item md-size-20 md-small-size-100">
                                    ...
                                    <md-field :class="{'md-invalid': errors.has('Tou-Form.start'+tou.id)}">
                                        ...
                                        <md-select v-model="tou.start" :name="$tc('words.start')" id="start"
                        ...
                        <div class="md-layout-item md-size-100"
                            ...
                            <form class="md-layout md-gutter" data-vv-scope="Social-Form">
                                ...
                                <div class="md-layout-item md-size-20 md-small-size-50 ">
                                    <md-field
                                        :class="{'md-invalid': errors.has('Social-Form.' + $tc('phrases.socialTariffLabels'))}">
                                        ...
                                        <span class="md-error">{{
                                                errors.first('Social-Form.' + $tc('phrases.socialTariffLabels'))
                                            }}</span>
                                ...
                                >
                                    <md-field
                                        :class="{'md-invalid': errors.has('Social-Form.' + $tc('phrases.socialTariff',1))}">
                                        ...
                                        />
                                        <span class="md-error">{{
                                                errors.first('Social-Form.' + $tc('phrases.socialTariff', 1))
                                            }}</span>
                                ...
                                >
                                    <md-field
                                        :class="{'md-invalid': errors.has('Social-Form.' + $tc('phrases.socialTariff',2))}">
                                        ...
                                        <span
                                            class="md-error">{{
                                                errors.first('Social-Form.' + $tc('phrases.socialTariff', 2))
                                            }}</span>
                                        <span class="md-suffix">Wh.</span>
                                    </md-field>
                                </div>
                                ...
                                >
                                    <md-field
                                        :class="{'md-invalid': errors.has('Social-Form.' + $tc('phrases.socialTariffLabels',2))}">
                                        ...
                                        <span
                                            class="md-error">{{
                                                errors.first('Social-Form.' + $tc('phrases.socialTariffLabels', 2))
                                            }}</span>
                                        <span class="md-suffix">Wh.</span>
                                    </md-field>
                                </div>
                ...
                <md-card-actions>
                    <md-button role="button" class="md-raised md-primary" :disabled="loading" @click="saveTariff">
                        {{ $tc('words.save') }}
                    </md-button>

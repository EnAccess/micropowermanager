      ...
      <div class="exclamation">
        <div>
          ...
          <div class="md-layout-item md-size-100">
            <md-button class="md-raised md-primary" @click="closeStepper()">
              {{ $tc("words.done") }}
            </md-button>
          </div>
        </div>
    ...
    async nextStep(id, index) {
      ...
      if (id === "firstStep" && index === "secondStep") {
        ...
        try {
          ...
          let type =
            this.purchasingType === "logger" ? "mini-grid" : "maintenance"

          let codeIsValid = await this.restrictionService.purchaseCodeIsValid(
            this.purchaseCode,
            productCode,
            type,
          )

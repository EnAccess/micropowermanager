        ...
        <md-card>
            <md-card-content>
                <div class="md-layout md-gutter">
                    ...
                    <div class="md-layout-item">
                        ...
                        >
                            ...
                            <md-select
                                ...
                                v-validate="'required'"
                            >
                                <md-option selected disabled>
                                    -- {{ $tc('phrases.newTarget', 2) }} --
                                </md-option>
                                <md-option value="cluster">
                                    {{ $tc('words.cluster') }}
                                </md-option>
                            ...
                            <span class="md-error">
                                {{ errors.first($tc('phrases.assignFor', 2)) }}
                            </span>
                        </md-field>
                    </div>
                    ...
                    <div class="md-layout-item">
                        ...
                        >
                            ...
                            <span class="md-error">
                                {{ errors.first($tc('phrases.assignTo', 2)) }}
                            </span>
                        </md-field>
                    </div>
                    ...
                    <div class="md-layout-item">
                        ...
                        >
                            ...
                            <span class="md-error">
                                {{ errors.first($tc('phrases.validUntil')) }}
                            </span>
                        </md-datepicker>
                    </div>
                </div>
                ...
                <div class="new-target" v-if="!isMobile">
                    ...
                    <md-table>
                        <md-table-row
                            v-for="connection in connectionTypes.list"
                            :key="connection.id"
                        >
                            ...
                            <md-table-cell>
                                <md-field>
                                    ...
                                    <md-input
                                        ...
                                        v-model="
                                            connection.target.newConnection
                                        "
                                    />
                                </md-field>
                            </md-table-cell>
                            ...
                            <md-table-cell>
                                <md-field>
                                    <label>
                                        {{ $tc('phrases.connectedPower') }}
                                    </label>
                                    <md-input
                                        type="number"
                                        class="form-control full-width"
                                        v-model="
                                            connection.target.connectedPower
                                        "
                                    />
                                </md-field>
                            </md-table-cell>
                            ...
                            <md-table-cell>
                                <md-field>
                                    ...
                                    <md-input
                                        ...
                                        class="form-control full-width"
                                        v-model="
                                            connection.target.energyPerMonth
                                        "
                                    />
                                </md-field>
                            </md-table-cell>
                            ...
                            <md-table-cell>
                                {{
                                    addCustomers(
                                        connection.target.newConnection,
                                        numberOfCustomers.findConnectionCustomers(
                                            connection.id,
                                        ),
                                    )
                                }}
                        ...
                        <md-table-row>
                            ...
                            <md-table-cell>
                                {{ total['connectedPower'] }}
                            </md-table-cell>
                            <md-table-cell>
                                {{ total['energyPerMonth'] }}
                            </md-table-cell>
                            <md-table-cell>
                                {{ readable(total['totalRevenue']) }}
                            </md-table-cell>
                            <md-table-cell>
                                {{
                                    readable(
...
export default {
    ...
    computed: {
        ...
        total: {
            ...
            get: function () {
                ...
                this.connectionTypes.list.reduce(function (prev, next) {
                    prev['averageRevenuePerMonth'] += parseInt(
                        next['target']['averageRevenuePerMonth'],
                    )
                    prev['connectedPower'] += parseInt(
                        next['target']['connectedPower'],
                    )
                    prev['energyPerMonth'] += parseInt(
                        next['target']['energyPerMonth'],
                    )
                    prev['newConnection'] += parseInt(
                        next['target']['newConnection'],
                    )
                    prev['totalRevenue'] += parseInt(
                        next['target']['totalRevenue'],
                    )
                    return prev
                }, total)
                return total
    ...
    methods: {
        ...
        async submitTarget() {
            ...
            try {
                await this.targets.store(
                    this.targetValidUntil,
                    this.targetAssignType,
                    this.targetAssignId,
                    this.connectionTypes.list,
                )
                this.$swal(
                    'Success',
                    this.$tc('phrases.newTargetNotify', 2),
                    'success',
                )

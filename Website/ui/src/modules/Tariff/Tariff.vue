<template>
    <widget :title="$tc('phrases.tariffDetail')">
        <md-card>
            <md-card-content>
                <div class="md-layout md-gutter">
                        ...
                        >
                            ...
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Tariff-Form.' + $tc('words.price'),
                                        ),
                                    }"
                                >
                                    <label for="kwh_price">
                                        {{ $tc('phrases.newTariffLabels') }}
                                    </label>
                                    <md-input
                                        id="kwh_price"
                                        :name="$tc('words.price')"
                            ...
                            >
                                <md-checkbox
                                    :name="$tc('phrases.enableAccessRate')"
                                    :id="$tc('phrases.enableAccessRate')"
                                    v-model="hasAccessRate"
                                    @change="accessRateChange($event)"
                                >
                                    {{ $tc('phrases.enableAccessRate') }}?
                                </md-checkbox>
                            </div>
                            <div
                                class="md-layout-item md-size-50 md-small-size-100"
                                ...
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Tariff-Form.' +
                                                $tc(
                                                    'words.minimumPurchaseAmount',
                                                ),
                                        ),
                                    }"
                                >
                                    <label for="minimumPurchaseAmount">
                                        {{
                                            $tc(
                                                'phrases.minimumPurchaseAmountDescription',
                                            )
                                        }}
                                    </label>
                                    <md-input
                                        ...
                                        :name="
                                            $tc('words.minimumPurchaseAmount')
                                        "
                                        v-model="
                            ...
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Access-Rate-Form.' +
                                                $tc('phrases.accessRatePrice'),
                                        ),
                                    }"
                                >
                                    <label for="access_rate_price">
                                        {{ $tc('phrases.accessRatePrice') }}
                                    </label>
                                    <md-input
                                        id="access_rate_price"
                                        :name="$tc('phrases.accessRatePrice')"
                                        v-model="
                                            tariffService.tariff.accessRate
                                                .amount
                                        "
                                        v-validate="'required|decimal:2'"
                                    />
                                ...
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Access-Rate-Form.' +
                                                $tc(
                                                    'phrases.accessRatePeriodInDays',
                                                ),
                                        ),
                                    }"
                                >
                    ...
                    <div
                        class="md-layout-item md-size-100"
                        v-for="(component, index) in tariffService.tariff
                            .components"
                        :key="'component' + index"
                    >
                        <form
                            class="md-layout md-gutter"
                            data-vv-scope="Component-Form"
                        >
                            <div
                            ...
                            <div
                                ...
                                @click="
                                    removeComponent('component', component.id)
                                "
                            >
                    ...
                    >
                        <form
                            class="md-layout md-gutter"
                            data-vv-scope="Tou-Form"
                        >
                            <div
                                class="md-layout-item md-size-20 md-medium-size-50 md-small-size-100"
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Tou-Form.start' + tou.id,
                                        ),
                                    }"
                                >
                                    <label for="name">
                            ...
                            <div
                                class="md-layout-item md-size-15 md-medium-size-45 md-small-size-95"
                            >
                                <md-field>
                                    <label for="value">
                                        {{ $tc('words.cost') }}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <md-input
                                        ...
                                        min="0"
                                        :name="
                                            $tc('phrases.socialTariffLabels')
                                        "
                                        v-model="
                                            tariffService.tariff.socialTariff
                                                .dailyAllowance
                                        "
                            ...
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Social-Form.' + $tc('words.price'),
                                        ),
                                    }"
                                >
                                    <label for="social_price">
                                        {{ $tc('phrases.socialTariff', 1) }}
                                    </label>
                                    <md-input
                                        id="social_price"
                                        :name="$tc('words.price')"
                            ...
                            >
                                <md-field
                                    :class="{
                                        'md-invalid': errors.has(
                                            'Social-Form.' +
                                                $tc('phrases.socialTariff', 2),
                                        ),
                                    }"
                                >
                                    <md-input
                                        id="initial_energy_budget"
                                        type="number"
                                        min="0"
                            ...
                            >
                                <h3>
                                    {{ $tc('phrases.socialTariffLabels', 2) }}
                                </h3>
                            </div>
                            <div
                                class="md-layout-item md-size-20 md-small-size-50"
...
export default {
    ...
    methods: {
        ...
        async showConfirmation() {
            let countObject = await this.tariffService.tariffUsageCount(
                this.tariffId,
            )
            ...
            if (usageCount > 0) {
                text = this.$tc('phrases.tariffNotify', 2, {
        ...
        async updateTariff() {
            ...
            if (this.hasAccessRate)
                validatorAccessRate =
                    await this.$validator.validateAll('Access-Rate-Form')
            if (this.tariffService.socialOptions)
                validatorSocial =
                    await this.$validator.validateAll('Social-Form')
            if (this.tariffService.tariff.components.length > 0)
                validatorComponent =
                    await this.$validator.validateAll('Component-Form')
            ...
            if (
                ...
                try {
                    this.loading = true
                    this.tariffService.setCurrency(
        ...
        touSelected(event) {
            this.tariffService.times.filter((x) => x.time === event)[0].using =
                true
        ...
        touValueChange(tou) {
            if (this.tariffService.tariff.price) {
                let price = this.tariffService.tariff.price

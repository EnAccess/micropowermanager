                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <md-input
                                        ...
                                        name="serial_number"
                                        v-model="
                                            eBikeService.eBike.serialNumber
                                        "
                            ...
                            >
                                ...
                                >
                                    ...
                                    <md-select
                                        v-model="
                                            eBikeService.eBike.manufacturerId
                                        "
                                        name="manufacturer"
                                        id="manufacturer"
                                        v-validate="'required'"
...
export default {
    ...
    methods: {
        async save() {
            const validator =
                await this.$validator.validateAll('eBike-add-form')
            if (validator) {
                this.loading = true
                try {

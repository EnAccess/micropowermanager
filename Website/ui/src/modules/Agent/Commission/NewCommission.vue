<template>
    <widget v-if="addNewCommission" :title="$tc('phrases.addCommissionType')">
        <form novalidate class="md-layout" @submit.prevent="saveCommission">
            <md-card class="md-layout-item">
                ...
                <md-card-content>
                    <md-field
                        :class="{ 'md-invalid': errors.has($tc('words.name')) }"
                    >
                        ...
                        <md-input
                            ...
                            id="name"
                            v-model="
                                agentCommissionService.agentCommission.name
                            "
                    ...
                    >
                        ...
                        <md-input
                            ...
                            id="energyCommission"
                            v-model="
                                agentCommissionService.agentCommission
                                    .energyCommission
                            "
        ...
        async saveCommission() {
            ...
            if (validator) {
                ...
                try {
                    ...
                    this.alertNotify(
                        'success',
                        this.$tc('phrases.addCommissionType', 2),
                    )
                } catch (e) {
                    this.loading = false

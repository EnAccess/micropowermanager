<template>
    <div>
        <h2>
            Ticket Settings ( {{ ticketSettingsService.ticketSettings.name }} )
        </h2>
        <div class="md-layout md-size-100">
            <md-field :class="{ 'md-invalid': errors.has('api_token') }">
                ...
                <md-input
                    ...
                    id="api_token"
                    v-validate="'required'"
                    v-model="ticketSettingsService.ticketSettings.apiToken"
                ></md-input>
            </md-field>
        ...
        <div class="md-layout md-size-100">
            <md-field :class="{ 'md-invalid': errors.has('api_key') }">
                ...
                <md-input
                    ...
                    id="api_key"
                    v-validate="'required'"
                    v-model="ticketSettingsService.ticketSettings.apiKey"
                ></md-input>
            </md-field>
        ...
        <div class="md-layout md-size-100">
            <md-field :class="{ 'md-invalid': errors.has('api_url') }">
                ...
                <md-input
                    ...
                    id="api_url"
                    v-validate="'required'"
                    v-model="ticketSettingsService.ticketSettings.apiUrl"
                ></md-input>
            </md-field>
    ...
    methods: {
        ...
        async updateTicketSettings() {
            ...
            try {
                ...
                this.$store
                    .dispatch(
                        'settings/setTicketSettings',
                        this.ticketSettingsService.ticketSettings,
                    )
                    .then(() => {})
                    .catch((err) => {
                        console.log(err)

    ...
    <div>
        ...
        <div class="md-layout md-gutter md-size-100">
            <div class="md-layout-item md-size-33">
                <md-field
                    :class="{ 'md-invalid': errors.has($tc('words.host')) }"
                >
                    ...
                    ></md-input>
                    <span class="md-error">
                        {{ errors.first($tc('words.host')) }}
                    </span>
                </md-field>
            </div>
            <div class="md-layout-item md-size-33">
                <md-field
                    :class="{ 'md-invalid': errors.has($tc('words.port')) }"
                >
            ...
            <div class="md-layout-item md-size-33">
                <md-field
                    :class="{
                        'md-invalid': errors.has($tc('words.encryption')),
                    }"
                >
                    <label>{{ $tc('words.encryption') }}</label>
                    <md-input
                        :name="$tc('words.encryption')"
                        v-model="
                            mailSettingsService.mailSettings.mailEncryption
                        "
                        :id="$tc('words.encryption')"
                        v-validate="'required|min:3'"
                    ></md-input>
                    <span class="md-error">
                        {{ errors.first($tc('words.encryption')) }}
                    </span>
                </md-field>
            </div>
        </div>
        <div class="md-layout md-gutter md-size-100">
            <div class="md-layout-item md-size-50">
                <md-field
                    :class="{ 'md-invalid': errors.has($tc('words.email')) }"
                >
            ...
            <div class="md-layout-item md-size-50">
                <md-field
                    :class="{ 'md-invalid': errors.has($tc('words.password')) }"
                >

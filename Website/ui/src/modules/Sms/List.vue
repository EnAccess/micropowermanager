<template>
    <div>
        <div class="wide-screen-sms-list md-layout md-gutter">
                                ...
                                >
                                    <div class="md-layout md-gutter">
                                        ...
                                        <div class="md-layout-item md-size-55">
                                            ...
                                            >
                                                <div
                                                    class="md-layout-item md-size-100 sms-owner"
                                                    v-if="sms.owner"
                                                >
                                                    {{ sms.owner.name }}
                                                    {{ sms.owner.surname }}
            ...
            <div
                class="md-layout-item md-size-70 md-medium-size-60 md-small-size-100"
                v-if="checkScreen('detail')"
            >
                <widget>
                    ...
                    <div class="sms-detail-scrollable">
                        ...
                        >
                            <div
                                class="md-layout-item md-layout md-size-100 md-gutter"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="sms-body-triangle left-arrow"
                                        ></div>
                                        <div
                                            class="md-layout-item sms-body sms-body-left"
                                        >
                                            {{ sms.body }}
                                        </div>
                                    </div>
                                ...
                                >
                                    <div
                                        class="md-layout-item md-layout md-gutter"
                                    >
                                        <div class="md-layout-item sms-body">
                                            {{ sms.body }}
                                        </div>
                                        <div
                                            class="sms-body-triangle right-arrow"
                                        ></div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        async sendSms() {
            ...
            try {
                this.loading = true
                await this.smsService.sendToNumber(
                    'person',
                    this.message,
                    this.selectedNumber,
                    this.senderId,
                ...
                this.alertNotify(
                    'success',
                    this.$tc('phrases.smsListNotify', 2),
                )
                this.message = ''

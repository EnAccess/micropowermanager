                    ...
                    <div class="md-layout md-gutter">
                        ...
                        >
                            ...
                            <div class="md-layout">
                                ...
                                <div
                                    v-if="editConnectionType"
                                    class="md-layout-item md-subheader n-font"
                                >
                                    {{ connectionType.name }}
                                    <md-button
                                        class="md-icon-button"
                                        @click="toggleEditConnectionType"
                                    >
                                ...
                                >
                                    ...
                                    >
                                        <label for="connectionTypeName">
                                            {{
                                                $tc(
                                                    'phrases.editConnectionType',
                                                )
                                            }}
                                        </label>
                                        <md-input
                            ...
                            <div class="md-layout">
                                <div class="md-layout-item md-subheader">
                                    {{ $tc('phrases.createdAt') }}
                                </div>
                                <div class="md-layout-item md-subheader n-font">
                                    {{
                                        formatReadableDate(
                                            connectionType.created_at,
                                        )
                                    }}
                                </div>
                            </div>
            ...
            <md-card>
                    ...
                    <div class="md-layout md-gutter">
                        ...
                        >
                            ...
                            >
                                ...
                                <md-select
                                    v-model="subConnectionType.tariff_id"
                                    v-validate="'required'"
                                    :name="$tc('words.tariff')"
                                    id="tariff"
                                >
                                    <md-option
                                        v-for="t in tariff"
                ...
                <md-card-actions>
                    <md-button
                        ...
                        @click="saveSubType(subConnectionType)"
                    >
                        {{ $tc('words.save') }}
                    </md-button>
                    <md-button
                ...
                <md-card-content>
                    <md-table>
                        ...
                        >
                            ...
                            <md-table-cell>
                                <div
                                    v-if="editSubConnectionType === subType.id"
                                >
                                    <md-field
                                        :class="{
                                            'md-invalid': errors.has(
                                    ...
                                    >
                                        <label for="subConnectionTypeName">
                                            {{
                                                $tc(
                                                    'phrases.editSubConnectionType',
                                                )
                                            }}
                                        </label>
                                        <md-input
                            ...
                            <md-table-cell>
                                ...
                                >
                                    <md-button
                                        class="md-icon-button"
                                        @click="
                                            updateSubConnectionType(subType)
                                        "
                                    >
                                        <md-icon>save</md-icon>
                                    </md-button>
                                    <md-button
                                        class="md-icon-button"
                                        @click="editSubConnectionType = null"
                                    >
                                        <md-icon>close</md-icon>
                                    </md-button>
                                </div>
                                <div v-else>
                                    <md-button
                                        class="md-icon-button"
                                        @click="
                                            editSubConnectionType = subType.id
                                        "
                                    >
                                        <md-icon>edit</md-icon>
                                    </md-button>
    ...
    methods: {
        ...
        async updateSubConnectionType(subType) {
            ...
            this.$swal({
                ...
                if (this.checkConfirm(response)) {
                    try {
                        this.subConnectionTypeService.updateSubConnectionType(
                            subType,
                        )
                        this.editSubConnectionType = null
                        this.alertNotify(
                            'success',
                            this.$tc('phrases.editSubConnectionTypeNotify', 2),
                        )
                    } catch (e) {
        ...
        async editConnectionTypeName() {
            ...
            this.$swal({
                ...
                text: this.$tc('phrases.editConnectionTypeNotify', 2, {
                ...
                if (this.checkConfirm(response)) {
                    try {
                        this.connectionTypeService.updateConnectionType(
                            this.connectionType,
                        )
                        this.toggleEditConnectionType()
                        this.alertNotify(
                            'success',
                            this.$tc('phrases.editConnectionTypeNotify', 1),
                        )
                    } catch (e) {
                        this.alertNotify('error', e.message)
                    }
        ...
        async saveSubType(subConnectionType) {
            ...
            try {
                await this.subConnectionTypeService.createSubConnectionType(
                    subConnectionType,
                )
                this.alertNotify(
                    'success',
                    this.$tc('phrases.newSubConnectionType', 2),
                )
                this.addSubType()
                this.clearForm()
            } catch (e) {
        ...
        async getConnectionTypeDetail(connectionTypeId) {
            try {
                this.connectionType =
                    await this.connectionTypeService.getConnectionTypeDetail(
                        connectionTypeId,
                    )
                EventBus.$emit(
                    'widgetContentLoaded',
                    this.subscriber.detail,
                    this.connectionType,
                )
            } catch (e) {
                this.alertNotify('error', e.message)

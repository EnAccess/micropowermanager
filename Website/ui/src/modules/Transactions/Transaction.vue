                        ...
                        >
                            <md-card>
                                <md-card-content>
                                    <div class="md-layout">
                                        <div
                                            class="md-layout-item md-subheader"
                                        >
                                            {{ $tc('words.sender') }}
                                        </div>
                                        <div
                                    ...
                                    <div class="md-layout">
                                        ...
                                        >
                                            {{
                                                $tc(
                                                    `words.${transaction.device.device_type}`,
                                                )
                                            }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="md-layout">
                                        ...
                                        <div
                                            class="md-layout-item md-subheader n-font"
                                            v-if="
                                                transaction.payment_histories[0]
                                                    .paymentHistory &&
                                                transaction.device
                                                    .device_type === 'meter'
                                            "
                                        ...
                                        >
                                            <ul style="margin: auto">
                                                <li>
                                                    {{
                                                        $tc(
                                                            'phrases.untraceableTransaction',
                                                        )
                                                    }}
                                                </li>
                                            </ul>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <md-table-row
                                                        v-for="(
                                                            p, i
                                                        ) in transaction.payment_histories"
                                                        :key="i"
                                                    >
                                                        <md-table-cell>
                                                            <p>
                        ...
                        >
                            <md-card>
                                <md-card-content>
                                    ...
                                    >
                                        <div
                                            class="md-layout-item md-subheader md-size-20"
                                        >
                                            {{ $tc('words.to') }}
                                        </div>
                                        <div
                                            class="md-layout-item md-subheader md-size-80"
                                        >
...
export default {
    ...
    methods: {
        async getDetail(id) {
            try {
                this.transaction =
                    await this.transactionService.getTransaction(id)
                console.log(this.transaction)
                if (
                    this.transaction.payment_histories[0].paymentHistory ===
                    true
                ) {

    ...
    <div>
        ...
        >
            <md-dialog-title><h4 style="font-size: 1.2rem; margin:0; border-bottom: solid 1px #dedede">
                {{ $tc('words.shs', 1) }}</h4></md-dialog-title>
                    ...
                    <div class="md-layout-item md-size-100">
                        <form class="md-layout md-gutter" data-vv-scope="shs-add-form">
                            ...
                            <div class="md-layout-item md-size-100 md-small-size-100">
                                <md-field :class="{'md-invalid': errors.has('shs-add-form.serial_number')}">
                            ...
                            <div class="md-layout-item md-size-50 md-small-size-100 ">
                                <md-field :class="{'md-invalid': errors.has('shs-add-form.manufacturer')}">
                                    ...
                                    <span class="md-error">{{ errors.first('shs-add-form.manufacturer') }}</span>
                                </md-field>
                            </div>

                            <!--asset list-->
                            <div class="md-layout-item md-size-50 md-small-size-100 ">
                                <md-field :class="{'md-invalid': errors.has('shs-add-form.appliance')}">
                                    ...
                                    <span class="md-error">{{ errors.first('shs-add-form.appliance') }}</span>
                                </md-field>
                            </div>
                        </form>
                    </div>
    ...
    methods: {
        async save () {
            ...
            if (validator) {
                this.loading = true
                try {
                    const createdShs = await this.solarHomeSystemService.createSolarHomeSystem()

...
class ValidationTests extends TestCase
{
    ...
    public function test_only_authenticated_swifta_user_sends_transaction()
    {
        $data = [
    ...
    public function test_without_invalid_cipher()
    {
        $data = [
            "meter_number" => "478881899",
            "amount" => 1000,
    ...
    public function test_without_non_existing_meter_number()
    {
        $this->initializeData();
        $data = [
    ...
    public function test_with_non_sender_address()
    {
        $this->initializeData();
    ...
    public function test_with_invalid_transaction_amount()
    {
        $this->initializeData();
    ...
    public function test_with_valid_transaction_amount()
    {
        $this->initializeData();
        $data = [
            "meter_number" => "4700005646",

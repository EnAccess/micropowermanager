...
{
    public function __construct(private SessionService $sessionService, private MeterConsumption $meterConsumption)
    {
        $this->sessionService->setModel($this->meterConsumption);
    }

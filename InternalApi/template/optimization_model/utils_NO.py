...
def load_minigrid_data(filename, steps):
    ...
    data = {None: {
        ...
        'tau': {None: float(df['parameters'].iloc[87,3])},
        ...
        'c_pv': {None: float(df['parameters'].iloc[6,3])},
        'c_bess': {None: float(df['parameters'].iloc[9,3])},
        'E_diesel': {None: float(df['parameters'].iloc[12,3])},
        'c_f':{None: float(df['parameters'].iloc[15,3])},
        'STC_dg': {None: float(df['parameters'].iloc[18,3])},
        'mrt': {None: float(df['parameters'].iloc[21,3])},
        'rt': {None: float(df['parameters'].iloc[24,3])},
        'b_dg': {None: float(df['parameters'].iloc[27,3])},
        'm_dg': {None: float(df['parameters'].iloc[30,3])},
        'q_a': {None: float(df['parameters'].iloc[36,3])},
        # 'q_b': {None: float(df['parameters'].iloc[39,3])},
        'eta_dg': {None: float(df['parameters'].iloc[48,3])},
        'SOC_max': {None: float(df['parameters'].iloc[51,3])},
        'SOC_min': {None: float(df['parameters'].iloc[54,3])},
        'sigma_bess': {None: float(df['parameters'].iloc[57,3])},
        'eta_char': {None: float(df['parameters'].iloc[60,3])},
        'eta_disc': {None: float(df['parameters'].iloc[63,3])},
        'SOC_ini': {None: float(df['parameters'].iloc[66,3])},
        'E_pv_inv': {None: float(df['parameters'].iloc[69,3])},
        'eta_pv_inv': {None: float(df['parameters'].iloc[72,3])},
        'E_ir': {None: float(df['parameters'].iloc[75,3])},
        'eta_rect': {None: float(df['parameters'].iloc[78,3])},
        'eta_bess_inv': {None: float(df['parameters'].iloc[81,3])},
        'lower_limit_diesel': {None: float(df['parameters'].iloc[84,3])}, 
        'L_char': {None: float(df['parameters'].iloc[90,3])}, 
        'L_disch': {None: float(df['parameters'].iloc[93,3])}, 
        'p_mi': {None: float(df['parameters'].iloc[96,3])},
        'crypto_max': {None: float(df['parameters'].iloc[99,3])},
        'm_mi': {None: float(df['parameters'].iloc[102,3])},
        'b_mi': {None: float(df['parameters'].iloc[105,3])},
        'K_mi': {None: float(df['parameters'].iloc[108,3])}, 
        'crypto_min': {None: float(df['parameters'].iloc[111,3])}
    }}

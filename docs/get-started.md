...
MicroPowerManager (MPM) is an open source, free-of-charge software that enables companies in the rural electrification space manage their portfolio of customers. It is designed to be suitable both to mini-grid operations as well as solar-home-system (SHS) distributors.
...
1.	Click on the APK app files via your phone (Android required) – For Agent App Android version 6 or above is required)
2.	Apps get installed
3.	Once the app is installed on the phone, you will be asked for an URL: following URL can be used: https://staging.micropowermanager.com
4.	Log in to the apps with the login credentials used to access MPM website interface.

...
E-bike devices can be registered via the [Field App](android-apps#customers) or directly through the website interface (Select "E-bike" menu on the left sidebar --> Click ":heavy_plus_sign:" --> introduce device data as requested.)

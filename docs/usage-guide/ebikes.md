...
E-bike devices can be registered via the Customer Registration App (see "Android Apps" section) or directly through the website interface (Select "E-bike" menu on the left sidebar --> Click ":heavy_plus_sign:" --> introduce device data as requested.)

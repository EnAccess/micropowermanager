...
> [!NOTE]
> MPM was originally developed to enable the recording of responses from maintenance service providers on the MPM account (provided the user relies on the [SMS Gateway App](android-apps#sms-gateway-app)).

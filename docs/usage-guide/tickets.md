...
1. **Ticket for a specific customer:**
   ...
   > [!NOTE]
   > Agents at present can create tickets but cannot be assigned tickets (unlike maintenance service providers). This may be adjusted with additional development work or by first registering the Agent as well as a "Maintenance Service Provider" in MPM.

...
The "Meter" menu is a list of all registered electricity meter devices on the MPM account.
...
As outlined on the "Setting up your MPM company account" above, registering a new meter device must be done via the Customer Registration App.
What can be done from the MPM website interface is re-assign existing meters from customer to customer.

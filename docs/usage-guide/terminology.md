...
| Cluster     | The area that covers the grouped Mini-Grids or solar home systems.                                                                                                                    |
...
| Asset Type  | An object, that could be sold to locals to help/improve their productivity or live quality (includes as well solar home systems)                                                                     |
...
| Agent | Persons entrusted by the company to react to customer complaints on site as well as generate STS tokens for the purchase of electricity on behalf of customers |